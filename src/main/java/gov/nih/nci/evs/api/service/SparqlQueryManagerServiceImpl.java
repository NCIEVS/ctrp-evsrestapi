...
public class SparqlQueryManagerServiceImpl
   ...
   * "C4715", "C4536", "C35850", "C54293", "C9315", "C8990", "C9272", "C9466",
   * "C3871", "C9465", "C9105", "C4855", "C4815", "C8054", "C4035", "C3879",
   * "C4906", "C7569", "C3513", "C4911", "C3850", "C7927", "C3099", "C27814",
   * "C4436", "C36077", "C35417", "C7109", "C3844", "C3908", "C7724", "C9330",
   * "C2955", "C4910", "C9382", "C9291", "C4878", "C2926", "C4917", "C4872",
   * "C4908", "C3867", "C7558", "C9039", "C3917", "C4866", "C9061", "C4863",
   * "C40022", "C7352", "C9325", "C9385", "C6142", "C8993", "C4912", "C9106",
   * "C4914", "C9312", "C9145", "C2946", "C9306", "C3158", "C3359", "C3194",
   * "C3088", "C9087", "C3230", "C3059", "C3224", "C3510", "C8711", "C4817",
   * "C3270", "C3790", "C9344", "C2947", "C3716", "C5669", "C3728", "C3267",
   * "C6906", "C3403", "C3752", "C3753", "C2996", "C9309", "C3011", "C4290",
   * "C9063", "C3422", "C2948", "C4699", "C3161", "C3172", "C3171", "C3174",
   * "C3178", "C7539", "C3167", "C3163", "C9290", "C3247", "C4665", "C9349",
   * "C3242", "C3208", "C9357", "C38661", "C3211", "C3773", "C7541", "C3411",
   * "C3234", "C61574", "C2991", "C3262", "C2916", "C9118", "C3268", "C3264",
   * "C3708", "C27134", "C3809", "C3058", "C3017","C9384", "C4767", "C4016",
   * "C7073", "C7515", "C4896","C54705"};
   */
  ...
  public void populateCache() throws IOException {
    ...
    List<Concept> mainTypes =
        getConceptInSubset(CTS_API_Disease_Main_Type_Terminology_Code);
    ...
    List<Concept> categories =
        getConceptInSubset(CTS_API_Disease_Broad_Category_Terminology_Code);
    ...
    /*
     * HashSet <String> mainTypeSet = new HashSet <String>(); for (int i = 0; i
     * < CTRP_MAIN_CANCER_TYPES.length; i++) {
     * mainTypeSet.add(CTRP_MAIN_CANCER_TYPES[i]); }
     * 
     * ArrayList <String> categoryList = new ArrayList <String>();
     * categoryList.add("C2991"); categoryList.add("C3262");
     * categoryList.add("C2916");
     */

    log.info("  starting main hierarchy");
    mainTypeHierarchyUtils = new MainTypeHierarchyUtils(parentchild,
        mainTypeSet, categoryList, diseaseStageConcepts, diseaseGradeConcepts);
  ...
  public boolean checkConceptExists(String conceptCode)
  ...
  public List<EvsSubconcept> getEvsSubconcepts(String conceptCode)
    throws JsonMappingException, JsonParseException, IOException {
  ...
  public List<EvsSuperconcept> getEvsSuperconcepts(String conceptCode)
    throws JsonMappingException, JsonParseException, IOException {
  ...
  public List<EvsAssociation> getEvsRoles(String conceptCode)
    throws JsonMappingException, JsonParseException, IOException {
  ...
  public EvsConcept getConcept(EvsConcept evsConcept, String conceptCode)
     ...
     * evsConcept.setIsDiseaseStage(true); } else{
     ...
     * evsConcept.setIsDiseaseGrade(true); } else{
     ...
     * evsConcept.setIsMainType(true); } else{ evsConcept.setIsMainType(false);
     * }
     */
  ...
  public EvsConceptFull getEvsConceptDetailFull(String conceptCode)
    throws JsonMappingException, JsonParseException, IOException {
  ...
  public EvsConceptFull getConceptFull(EvsConceptFull evsConcept,
    ...
    /*
     * List <EvsSubconcept> subconcepts = getEvsSubconcepts(conceptCode); List
     * <EvsSuperconcept> superconcepts = getEvsSuperconcepts(conceptCode); List
     * <EvsAssociation> associations = getEvsAssociations(conceptCode); List
     * <EvsAssociation> inverseAssociations =
     * getEvsInverseAssociations(conceptCode); List <EvsAssociation> roles =
     * getEvsRoles(conceptCode); List <EvsAssociation> inverseRoles =
     * getEvsInverseRoles(conceptCode); evsConcept.setSubconcepts(subconcepts);
     * evsConcept.setSuperconcepts(superconcepts);
     * evsConcept.setAssociations(associations);
     * evsConcept.setInverseAssociations(inverseAssociations);
     * evsConcept.setRoles(roles); evsConcept.setInverseRoles(inverseRoles);
     * evsConcept.setSynonyms(EVSUtils.getFullSynonym(axioms));
     * evsConcept.setAdditionalProperties(EVSUtils.getAdditionalProperties(
     * properties));
     */
    ...
    // List <EvsAssociation> inverseAssociations =
    // getEvsInverseAssociations(conceptCode);
  ...
  /*
   * This "isSubtype is temporary, will use new one developed by Kim in next
   * release
   */
  ...
  public EvsRelationships getEvsRelationships(String conceptCode)
    throws JsonMappingException, JsonParseException, IOException {
  ...
  public HashMap<String, String> getCtrpBiomarkerConcepts()
    throws JsonMappingException, JsonParseException, IOException {
  ...
  public HashMap<String, String> getCtrpReferenceGeneConcepts()
    throws JsonMappingException, JsonParseException, IOException {
  ...
  public HashMap<String, String> getDiseaseIsStageSourceCodes()
    throws JsonMappingException, JsonParseException, IOException {
  ...
  public HashMap<String, String> getDiseaseIsGradeSourceCodes()
    throws JsonMappingException, JsonParseException, IOException {
  ...
  public List<Concept> getConceptInSubset(String code)
    throws JsonMappingException, JsonParseException, IOException {
